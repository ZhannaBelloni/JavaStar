...
<body>
	...
	<p class='text'>JAVA was developed by James Gosling at Sun
		...
		compiling, and debugging programming easy. It helps to create reusable
		code and modular programs. Java is a class-based, object-oriented
		programming language and is designed to have as few implementation
		dependencies as possible. A general-purpose programming language made
		for developers to write once run anywhere that is compiled Java code
		can run on all platforms that support Java. Java applications are
		compiled to byte code that can run on any Java Virtual Machine.</p>
	<b></b>
	...
	<p class='text'>
		...
		of the oak tree outside this office. With a name change of “Green,” it
		was finally named to Java. The final name is derived from Java coffee.<b></b>

		Java programming language is inspired by the C/C++ style according to
		Gosling. The aim was to create a programming language independent of
		the underlying machine architecture.<b></b> The first public release
		of Java happened in 1995 as Java 1.0. New versions were released with
		time. Java also became the open source on November 13, 2006. It was
